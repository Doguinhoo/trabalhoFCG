...
/* void BuildTrianglesAndAddToVirtualScene(ObjModel* model, VirtualScene &virtualScene) {
    GLuint vertex_array_object_id;
    glGenVertexArrays(1, &vertex_array_object_id);
    glBindVertexArray(vertex_array_object_id);
...
//
GLuint CreateGpuProgramFromFiles(const char *vertex_shader_file_name, const char *fragment_shader_file_name) {
    GLuint vertex_shader_id = LoadShader_Vertex(vertex_shader_file_name);
    GLuint fragment_shader_id = LoadShader_Fragment(fragment_shader_file_name);
    ...
    GLuint gpuProgramID = CreateGpuProgram(vertex_shader_id, fragment_shader_id);
